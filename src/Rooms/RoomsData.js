...
//         <Rooms Data={Data}/>
//         {/* <li>
//           <Link to="/RoomsDetails/:123456">Features</Link> 
//           </li>
//         <Switch>
//           <Route exact path='/RoomsDetails/:123456' component={RoomDetails}/>
//           </Switch> */}
//         {/* {Data.map((x,index)=>{return
//            (<>
           
//             <Link to="/Roomsdetails">Features</Link>
           
//             <Route exact path='/Roomsdetails' render={()=><RoomDetails  newData={x}/>} />
//            </>)
